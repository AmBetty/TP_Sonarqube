...
public class FileBrowser {
    ...
    private Comparator<FolderObject> artistNameComparator() {
    ...
    private Comparator<FolderObject> albumNameComparator() {
        return (Comparator<FileObject>) (lhs, rhs) -> {
    ...
    private Comparator<FolderObject> trackNameComparator() {
        return (Comparator<FileObject>) (lhs, rhs) -> {
